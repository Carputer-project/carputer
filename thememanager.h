...
class ThemeManager : public QObject
{
    ...
    Q_PROPERTY(QColor gaugeBorderColor READ gaugeBorderColor NOTIFY themeChanged)
...
public:
    ...
    QColor gaugeBorderColor() const { return m_gaugeBorderColor; }
...
public slots:
    ...
    void setGaugeBorderMode(const QString &mode) {
        if (m_gaugeBorderMode == mode) return;
        m_gaugeBorderMode = mode;
        updateBorderColor();
...
private:
    ...
    void updateBorderColor() {
        if (m_gaugeBorderMode == "primary")
            m_gaugeBorderColor = m_carBlue;
        else if (m_gaugeBorderMode == "secondary")
            m_gaugeBorderColor = m_carOrange;
        else // "gauge" (default)
            m_gaugeBorderColor = m_gaugeColor;
    }
    ...
    QColor m_gaugeBorderColor;
    QString m_gaugeBorderMode{"gauge"};
};
